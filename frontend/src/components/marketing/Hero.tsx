  ...
  return (
    ...
    >
      ...
      <g transform="translate(60, 100)">
        <text x="60" y="-20" textAnchor="middle" fontSize="11" fontWeight="600" fill="#64748B" letterSpacing="1">COHORT</text>
      ...
      <g transform="translate(300, 240)">
        ...
        <circle cx="0" cy="0" r="90" fill="none" stroke="#4F46E5" strokeWidth="2" strokeOpacity="0.3" />
        <circle cx="0" cy="0" r="65" fill="none" stroke="#4F46E5" strokeWidth="2.5" strokeOpacity="0.55" />
        <circle cx="0" cy="0" r="40" fill="none" stroke="#4F46E5" strokeWidth="3" strokeOpacity="1" />

        <circle cx="0" cy="0" r="14" fill="#F97316" />

        <text x="0" y="135" textAnchor="middle" fontSize="12" fontWeight="700" fill="#1E1B4B" letterSpacing="2">JEET</text>
        <text x="0" y="152" textAnchor="middle" fontSize="9" fill="#64748B" letterSpacing="1">AI-Powered Retention</text>
      </g>
      ...
      <g transform="translate(440, 100)">
        <text x="60" y="-20" textAnchor="middle" fontSize="11" fontWeight="600" fill="#64748B" letterSpacing="1">14 DAYS LATER</text>
        ...
        <g transform="translate(-10, 185)">
          <rect x="0" y="0" width="140" height="32" rx="16" fill="#22C55E" fillOpacity="0.1" stroke="#22C55E" strokeWidth="1" />
          <text x="70" y="20" textAnchor="middle" fontSize="12" fontWeight="700" fill="#15803D">+12% retention</text>
        </g>
      </g>
    </svg>
  );
    ...
    <section className="relative overflow-hidden bg-white">
      <div className="mx-auto max-w-7xl px-6 py-20 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 text-xs font-semibold tracking-wide text-indigo-700">
              <span className="h-1.5 w-1.5 rounded-full bg-orange-500 animate-pulse" />
              JEET — AI-Powered Student Retention
            </div>
