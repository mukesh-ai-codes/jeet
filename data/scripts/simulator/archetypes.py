...
DILIGENT_STRUGGLER = ArchetypeProfile(
    ...
    doubt_asking_frequency=1.0,  # Asks lots of basic doubts
...
UNENGAGED_GENIUS = ArchetypeProfile(
    ...
    doubt_asking_frequency=0.1,  # Rarely, but deep
...
HOSTEL_BURNOUT = ArchetypeProfile(
    ...
    doubt_asking_frequency=0.3,  # Decreases over time
...
PARENT_FORCED = ArchetypeProfile(
    ...
    doubt_asking_frequency=0.1,  # Doesn't care enough to ask
